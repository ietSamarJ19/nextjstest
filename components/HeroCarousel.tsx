...
const HeroCarousel = () => {
  ...
  // Sample college building images - replace with your actual images
  const slides = [
    {
      id: 1,
    ...
    },
    {
      ...
      description: "Empowering Students with World-class Resources"
    },
    {
      id: 3,
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute left-6 top-1/2 transform -translate-y-1/2 z-20 bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm"
        onClick={prevSlide}
      >
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute right-6 top-1/2 transform -translate-y-1/2 z-20 bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm"
        onClick={nextSlide}
      >
